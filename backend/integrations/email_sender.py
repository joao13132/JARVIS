...
Responda APENAS o JSON, sem texto adicional."""
    ...
    try:
        texto_resposta = gerar_resposta_json(prompt).strip()
        ...
        return "Não consegui entender os dados do email. Tente: envie um email para fulano@gmail.com com assunto teste dizendo olá."